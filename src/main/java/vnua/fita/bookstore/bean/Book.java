...
public class Book {
	...
	public Book(int bookId, String title, String author, Date orderDate, int orderPrice, int orderQuantity) {
		super();
		this.bookId = bookId;
		this.title = title;
		this.author = author;
	...
	public Book(int bookId, String title, String author, int price, int quantityInStock, Date orderDate) {
		super();
		this.bookId = bookId;
		this.title = title;
		this.author = author;
