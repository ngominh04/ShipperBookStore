...
public class OrderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (vnp_ResponseCode.equals("00")) {
			...
			if (OrderDao.checkAndUpdateAvaiableBookOfOrder(order)) {
				...
				if (insertResult) {
					req.setAttribute("cartOfCustomer", MyUtils.getCartOfCustomer(session));
				...
				MyUtils.updateCartOfCustomer(session, convertListToMap(order.getOrderBookList()));
				fowardPage = "/Views/cartView.jsp";
			}
			if (!isSuccess) {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if ("cash".equals(paymentMode) ||"cash".equals(paymentMode)) {
