		...
		<c:if test="${not empty book}">
			<form action="editBook" method="POST" enctype="multipart/form-data">
				...
				<table>
					...
					<tr>
						<td>Ảnh bìa sách</td>
						<td><img id="bookImage" src="${book.imagePath }" width="150">
							 <input type="hidden" value="${book.imagePath }" name="imagePath" />
					...
					<tr>
						...
						<td><textarea name="detail" id="editor" style="width: 100%" cols="10" rows="20">${book.detail }</textarea>
						<script>
